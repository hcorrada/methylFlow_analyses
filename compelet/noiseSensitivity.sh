...
echo 1 $start $length 100 10 1 20 $i 0 100 20 >> ${dir}/input.txt
...
echo 1 $start $length 100 4 1 20 $i 0 100 20 >> ${dir}/input.txt
...
echo 1 $start $length 100 2 1 20 $i 0 100 20 >> ${dir}/input.txt
