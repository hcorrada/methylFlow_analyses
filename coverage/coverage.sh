...
echo 1 757121 230 70 4 1 $i 0 80 1 >> /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate/input.txt
...
echo "MethylFlowCoverage"
../build/methylFlow/methylFlow -i /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate/shortRead.txt -o /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate  -l 1 -s 1 -chr 1
...
echo 1 757121 230 70 2 1 $i 0 80 1 >> /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple/input.txt
...
echo "MethylFlowCoverage"
../build/methylFlow/methylFlow -i /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple/shortRead.txt -o /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple/  -l 1 -s 1 -chr 1
...
#echo -n "" > eval.txt
#echo -n "" > input.txt
echo 1 757121 230 70 10 1 $i 0 80 1 >> /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/hard-Auto/input.txt
...
echo "MethylFlowCoverage"
../build/methylFlow/methylFlow -i /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/hard-Auto/shortRead.txt -o /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/hard-Auto/  -s 1 -chr 1
...
echo 1 757121 230 70 4 1 $i 0 80 1 >> /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate-Auto/input.txt
...
echo "MethylFlowCoverage"
../build/methylFlow/methylFlow -i /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate-Auto/shortRead.txt -o /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/moderate-Auto  -s 1 -chr 1
...
echo 1 757121 230 70 2 1 $i 0 80 1 >> /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple-Auto/input.txt
...
echo "MethylFlowCoverage"
../build/methylFlow/methylFlow -i /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple-Auto/shortRead.txt -o /cbcb/project-scratch/fdorri/Code/methylFlow/testing/coverage/simple-Auto/  -s 1 -chr 1
