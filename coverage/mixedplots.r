...
sel_s  <- with(coverageAvg_simple,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("5", "20", "35", "50")))
sel_m  <- with(coverageAvg_moderate,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("5", "20", "35", "50")))
sel_h  <- with(coverageAvg_hard,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("5", "20", "35", "50")))
