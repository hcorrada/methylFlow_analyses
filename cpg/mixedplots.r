...
sel_s  <- with(cpgAvg_simple,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("75", "100", "125", "150")))
sel_m  <- with(cpgAvg_moderate,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("50", "75", "100", "125", "150")))
sel_h  <- with(cpgAvg_hard,which(threshold %in% c("0.3","0.4","0.5","0.6","0.7","0.8")) && which(var %in% c("50", "75", "100", "125", "150")))
